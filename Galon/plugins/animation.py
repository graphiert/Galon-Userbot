...
from Galon import HANDLER as cmd
from ..utils.basic import eor, get_text
from ..utils.memes import MEMES
...
@Client.on_message(filters.command(["hearts",
                   "magic", "love"], cmd) & filters.me)
...
async def hajqag(client: Client, message: Message):
    if message.forward_from:
        return
    nama_saya = await client.get_me().first_name
    ...
    animation_chars = [
        ...
        f"`Me: Yo this is` {nama_saya} ,`Please Connect me to my lil bro,Pavel Durov `",
        "`User Authorised.`",
        "`Calling Saitama`  `At +916969696969`",
        "`Private  Call Connected...`",
        "`Me: Hello Sir, Please Ban This Telegram Account.`",
        "`Saitama : May I Know Who Is This?`",
        f"`Me: Yo Brah, I Am` {nama_saya} ",
...
@Client.on_message(filters.command(["gangsta",
                   "gang", "gangstar"], cmd) & filters.me)
...
@Client.on_message(filters.command("ysj", cmd) & filters.me)
...
HELP_CMD.update({PLUGIN_NAME: {
    ...
    "ysj": "Untuk menampilkan art y sj.",
    ...
    "pikachu": "to get a Pikachu Gifs",
    "kill": "To kill Someone randomly",
    "wtf": "Wtf animation",
    "ding": "Get Dong",
    "ganstar": "Animation Gangster",
    "charge": " Tesla animation charging"
}})
